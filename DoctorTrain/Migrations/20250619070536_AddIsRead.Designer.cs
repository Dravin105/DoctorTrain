...
namespace DoctorTrain.Migrations
{
    ...
    [Migration("20250619070536_AddIsRead")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorTrain.Model.Models.Auth.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DoctorTrain.Model.Models.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoctorTrain.Model.Models.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoctorTrain.Model.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("DoctorTrain.Model.Models.Patient", "Patients")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DoctorTrain.Model.Models.Auth.ApplicationUser", null)
                        .WithMany()
